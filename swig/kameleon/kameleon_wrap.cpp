...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__kameleon

#else
#  define SWIG_init    init_kameleon

#endif
#define SWIG_name    "_kameleon"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_runner(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:runner",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "runner" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = (int)runner(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "runner", _wrap_runner, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
