...
/*-----------------------------------------------
              @(target):= _inplace_cpp.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__inplace_cpp

#else
#  define SWIG_init    init_inplace_cpp

#endif
#define SWIG_name    "_inplace_cpp"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_inplacefn(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:inplacefn",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_double, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "inplacefn" "', argument " "1"" of type '" "double *""'"); 
  }
  arg1 = reinterpret_cast< double * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "inplacefn" "', argument " "2"" of type '" "int""'");
  } 
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "inplacefn", _wrap_inplacefn, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
